...
trade target.",
    ...
    ["item"] = {
        ...
        ["Lost Article"] = {
            ...
            ["zones"] = {
                [1] = "Ceizak Battlegrounds",
                [10] = "Moh Gates",
                [11] = "Dho Gates",
                [12] = "Woh Gates",
                [2] = "Yahse Hunting Grounds",
                [3] = "Foret de Hennetiel",
                [4] = "Cirdas Caverns",
                [5] = "Morimar Basalt Fields",
                [6] = "Marjami Ravine",
                [7] = "Kamihr Drifts",
                [8] = "Yorcia Weald",
                [9] = "Sih Gates",
...
",
        ...
        ["Bivouac#1 Administrator"] = {
            ["icon"] = "Service-Clerk.png",
            ["note"] = "Pioneer Coalition representative. Coordinates frontier logistics, distributes localized support tasks, and manages regional checkpoint functions.",
            ["type"] = "Service Clerk",
            ["zoneIds"] = {
                [1] = 260,
                [2] = 261,
...
* In the Land of the Blind",
        ...
        ["Lorissa"] = {
            ["icon"] = "Dialogue.png",
            ["note"] = "Notes:\
You need to have previously entered an Alluvion Skirmish before she will appear. She will store Mellidopt Wings traded to the ??? and exchange them for the following items. ---- ? Weapons ? Armour ? Augmentation Stones ? ----",
            ["type"] = "Mellidopt Trader",
            ["zoneIds"] = {
                [1] = 263,
            },
            ["zones"] = {
