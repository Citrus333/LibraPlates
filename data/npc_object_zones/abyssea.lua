...
* Look to the Sky",
        ...
        ["Alrauverat (A)"] = {
            ...
            ["icon"] = "Dialogue.png",
            ["note"] = "Notes:\
* Offers to teleport you below the ledge to Red Ghost.",
            ["type"] = "Field Encampment",
        },
        ["Amar (A)"] = {
            ["_source"] = "npc",
            ["icon"] = "Survivor,png",
...
* An Eye for Revenge",
        ...
        ["Deadly Spider (A)"] = {
            ...
            ["note"] = "Notes:\
* Reports your Abyssea - Grauberg objective progress.",
            ["type"] = "Goal Tracker",
        },
        ["Deraquien (A)"] = {
            ["_source"] = "npc",
...
* Family Ties",
        ...
        ["Nicadio (A)"] = {
            ...
            ["icon"] = "GoalTracker.png",
            ["note"] = "Notes:\
* Reports your Abyssea - Misareaux objective progress.",
            ["type"] = "Goal Tracker",
        },
        ["Nogelle (A)"] = {
            ["_source"] = "npc",
...
* A Moonlight Requite",
        ...
        ["Pulse Martello"] = {
            ...
            ["icon"] = "Dialogue.png",
            ["note"] = "Notes:\
* Bastion defense structure.\
* Used for Bastion battles and Resistance Ops.",
...
* The Walking Wounded",
        ...
        ["Red Ghost (A)"] = {
            ...
            ["icon"] = "Dialogue.png",
            ["note"] = "Notes:\
* Offers to teleport you up to Alrauverat and the Field Encampment.",
            ["type"] = "Field Encampment",
        },
        ["Regine (A)"] = {
            ["_source"] = "npc",
...
* Resistance Ops",
        ...
        ["Resistance Sergeant"] = {
            ...
            ["icon"] = "Dialogue.png",
            ["note"] = "Notes:\
* Shows resistance outpost status and horde invasion likelihood.",
            ["type"] = "Resistance Information",
        },
        ["Rhy Epocan (A)"] = {
            ["_source"] = "npc",
            ["icon"] = "Survivor,png",
...
* Imperial Espionage",
        ...
        ["Vavegallet (A)"] = {
            ...
            ["icon"] = "GoalTracker.png",
            ["note"] = "Notes:\
* Reports your Abyssea - Vunkerl objective progress.",
            ["type"] = "Goal Tracker",
        },
        ["Veit (A)"] = {
            ["_source"] = "npc",
