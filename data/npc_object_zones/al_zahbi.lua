...
* Aht Urhgan Mission 47: The Empress Crowned",
        ...
        ["Goblin Lansquenet"] = {
            ...
            ["note"] = "Notes:\
* Appears during high-defense Besieged.\
* Can turn hostile if Imperial Defense falls.",
...
Guard at the entrance at Walahra Temple",
        ...
        ["Kaduru-Haiduru"] = {
            ...
            ["icon"] = "WarpNPC.png",
            ["note"] = "Notes:\
* Warps you to Ru'Lude Gardens for an Imperial Silver Piece.\
* After repeated use, also offers a warp to your home nation.\
* Refuses service for one Vana'diel day after you use Shihu-Danhu.",
...
:* Answers questions about the Chamber of Passage, Runic Portals and Staging Points. :* Sells Runic Portal Use Permits for 200 Imperial Standing. :** He will not sell Runic Portal Use Permits if the Astral Candescence is in the hands of the beastmen. If you already had a permit prior to the Astral Candescence being taken, you will still be able to use it.",
        ...
        ["Shihu-Danhu"] = {
            ...
            ["icon"] = "WarpNPC.png",
            ["note"] = "Notes:\
* Free random warp to the Jeuno area.\
* Possible destinations worsen when the Astral Candescence is lost.\
* Using him blocks Kaduru-Haiduru's paid warp for one Vana'diel day.",
            ["type"] = "Teleport Service",
        },
        ["Silver Kettle"] = {
            ["_source"] = "npc",
