    ...
    ["item"] = {
        ["Beastmen's Banner"] = {
            ...
            ["zones"] = {
                ...
                [3] = "Cape Teriggan",
                [4] = "Eastern Altepa Desert",
                [5] = "Jugner Forest",
                [6] = "Meriphataud Mountains",
                [7] = "Pashhow Marshlands",
                [8] = "Qufim Island",
                [9] = "Qulun Dome",
            },
        },
        ...
        ["Field Manual"] = {
            ...
            ["zones"] = {
                [1] = "West Ronfaure",
                [10] = "Konschtat Highlands",
                [11] = "Rolanberry Fields",
                [12] = "Xarcabard",
                [13] = "Cape Teriggan",
                [14] = "Valley of Sorrows",
                [15] = "West Sarutabaruta",
                [16] = "East Sarutabaruta",
                [17] = "Tahrongi Canyon",
                [18] = "Buburimu Peninsula",
                [19] = "Meriphataud Mountains",
                [2] = "East Ronfaure",
                [20] = "Sauromugue Champaign",
                [21] = "The Sanctuary of Zi'Tah",
                [22] = "Ro'Maeve",
                [23] = "Yuhtunga Jungle",
                [24] = "Yhoator Jungle",
                [25] = "Western Altepa Desert",
                [26] = "Eastern Altepa Desert",
                [27] = "Qufim Island",
                [28] = "Behemoth's Dominion",
                [29] = "Ru'Aun Gardens",
                [3] = "La Theine Plateau",
                [4] = "Valkurm Dunes",
                [5] = "Jugner Forest",
        ...
        ["Mog-Tablet"] = {
            ...
            ["zones"] = {
                ...
                [10] = "Konschtat Highlands",
                [11] = "Rolanberry Fields",
                [12] = "Beaucedine Glacier",
                [13] = "Xarcabard",
                [14] = "Cape Teriggan",
                [15] = "Valley of Sorrows",
                [16] = "West Sarutabaruta",
                [17] = "East Sarutabaruta",
                [18] = "Tahrongi Canyon",
                [19] = "Buburimu Peninsula",
                [2] = "East Ronfaure",
                [20] = "Meriphataud Mountains",
                [21] = "Sauromugue Champaign",
                [22] = "The Sanctuary of Zi'Tah",
                [23] = "Ro'Maeve",
                [24] = "Yuhtunga Jungle",
                [25] = "Yhoator Jungle",
                [26] = "Western Altepa Desert",
                [27] = "Eastern Altepa Desert",
                [28] = "Qufim Island",
                [29] = "Behemoth's Dominion",
                [3] = "La Theine Plateau",
                [4] = "Valkurm Dunes",
                [5] = "Jugner Forest",
                [6] = "Batallia Downs",
        ...
        ["Overturned Soil"] = {
            ...
            ["zones"] = {
                [1] = "West Ronfaure",
                [10] = "Tahrongi Canyon",
                [11] = "Meriphataud Mountains",
                [12] = "Sauromugue Champaign",
                [2] = "La Theine Plateau",
                [3] = "Jugner Forest",
                [4] = "Batallia Downs",
                [5] = "South Gustaberg",
                [6] = "Konschtat Highlands",
                [7] = "Pashhow Marshlands",
                [8] = "Rolanberry Fields",
                [9] = "East Sarutabaruta",
            },
...
* Sin Hunting",
        ...
        ["Ardrick"] = {
            ["icon"] = "Merchant.png",
            ["note"] = "Notes:\
Provides players with assistance with Voidwatch operations or item issuance. *Ask a bunch of questions *Purchase Phase Displacers for 20,000 gil, which can be used to obtain {{KeyItem",
            ["type"] = "Pulse Exchange",
            ["zoneIds"] = {
                [1] = 104,
            },
