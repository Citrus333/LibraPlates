local expGuides = {
    ...
    modes = {
        ...
        cw_emilia = {
            ...
            paymentOptions = {
                { label = 'Pay with gil 100', result = 'Gil (100)' },
                { label = 'Pay with points 10', result = 'Conquest pts. (10)' },
            },
            destinations = {
                { label = 'Ronfaure', result = 'Ronfaure', region = 'Page 1', page = 1 },
                { label = 'Zulkheim', result = 'Zulkheim', region = 'Page 1', page = 1 },
                { label = 'Norvallen', result = 'Norvallen', region = 'Page 1', page = 1 },
                { label = 'Gustaberg', result = 'Gustaberg', region = 'Page 1', page = 1 },
                { label = 'Derfland', result = 'Derfland', region = 'Page 1', page = 1 },
                { label = 'Sarutabaruta', result = 'Sarutabaruta', region = 'Page 2', page = 2 },
                { label = 'Kolshushu', result = 'Kolshushu', region = 'Page 2', page = 2 },
                { label = 'Aragoneu', result = 'Aragoneu', region = 'Page 2', page = 2 },
                { label = 'Fauregandi', result = 'Fauregandi', region = 'Page 2', page = 2 },
                { label = 'Valdeaunia', result = 'Valdeaunia', region = 'Page 2', page = 2 },
                { label = 'Qufim', result = 'Qufim', region = 'Page 3', page = 3 },
                { label = "Li'Telor", result = "Li'Telor", region = 'Page 3', page = 3 },
                { label = 'Kuzotz', result = 'Kuzotz', region = 'Page 3', page = 3 },
                { label = 'Vollbow', result = 'Vollbow', region = 'Page 3', page = 3 },
                { label = 'Elshimo Lowlands', result = 'Elshimo Lowlands', region = 'Page 3', page = 3 },
                { label = 'Elshimo Uplands', result = 'Elshimo Uplands', region = 'Page 4', page = 4 },
                { label = 'Tavnazia', result = 'Tavnazia', region = 'Page 4', page = 4 },
                { label = 'Aht. Whitegate', result = 'Aht. Whitegate', region = 'Page 4', page = 4 },
                {
                    ...
                    page = 4,
                    paymentOptions = {
                        { label = 'Pay with gil 200', result = 'Gil (200)' },
                        { label = 'Pay with points 50', result = 'Conquest pts. (50)' },
                    },
                },
            },
        },
