return {
    ...
    ["catseyeNpc"] = {
        ["Mogrika"] = {
            ["icon"] = "Event.png",
            ["location"] = "Back of the Domain Invasion arena",
            ["note"] = "Mog Vault:\
...
trade target.",
    ...
    ["npc"] = {
        ...
        ["Diaphanous Transposer"] = {
            ["icon"] = "Dialogue.png",
            ["note"] = "Notes:\
* Grants entry to the Sortie battlefield in Outer Ra'Kaznar (U). *Approaching it after 20 hours have elapsed since your last Sortie will convert your {{KeyItem",
            ["type"] = "Instance Portal",
            ["zoneIds"] = {
                [1] = 267,
            },
            ["zones"] = {
