...
ashita.events.register('packet_in', 'libraplates_packet_in', function(e)
    ...
    errorBoundary.Call('packet_in.current_target_bar', 'Current-target bar incoming-packet handler', currentTargetBar.HandlePacketIn, e);
...
ashita.events.register('d3d_present', 'libraplates_present', function()
    ...
    errorBoundary.Call('present.ephemeral_box', 'Ephemeral Box toast render', ephemeralBox.HandlePresent);
