...
local sourceFixedFomorModels = {
    -- LandSandBoat mob_pools: Fomor_Red_Mage pool 1389 uses 0x05000804..., so
    -- the fixed model word is 0x0408 / 1032. Use this only where old family
    -- defaults are known to pick the wrong Hume female body.
    hume_female = 1032,
};
