return {
    ...
    ["item"] = {
        ...
        ["Armoury Crate"] = {
            ...
            ["zones"] = {
                [1] = "Bearclaw Pinnacle",
                [10] = "Zhayolm Remnants",
                [11] = "Arrapago Remnants",
                [12] = "Silver Sea Remnants",
                [13] = "Nyzul Isle",
                [14] = "Hazhalm Testing Grounds",
                [15] = "La Vaule [S]",
                [16] = "Beadeaux [S]",
                [17] = "Castle Oztroja [S]",
                [18] = "Balga's Dais",
                ...
                [21] = "Waughroon Shrine",
                [22] = "Throne Room",
                [23] = "Sacrificial Chamber",
                [24] = "Throne Room [S]",
                [25] = "Chamber of Oracles",
                [26] = "Throne Room",
                [3] = "The Shrouded Maw",
                [4] = "Mine Shaft #2716",
                [5] = "Monarch Linn",
                [6] = "Talacca Cove",
                [7] = "Navukgo Execution Chamber",
                [8] = "Jade Sepulcher",
                [9] = "Bhaflau Remnants",
            },
        },
    ...
    ["npc"] = {
        ...
        ["Aloysius, I.M."] = {
            ...
            ["note"] = "Notes:\
* Bastok affiliated Campaign Arbiter. Present when Bastok has control of La Vaule (S). *Offers Campaign Information, Campaign Allied Tags, Teleportation. *Campaign Sword in front of name during Campaign.",
            ["type"] = "Campaign",
            ["zoneIds"] = {
                [1] = 85,
            },
...
",
        ...
        ["Flasco-Rasco, C.C."] = {
            ["icon"] = "CampaignArbiter.png",
            ["note"] = "Notes:\
* Windurst affiliated Campaign Arbiter. Present when Windurst has control of La Vaule (S). *Offers Campaign Information, Campaign Allied Tags, Teleportation. *Campaign Sword in front of name during Campaign.",
            ["type"] = "Campaign",
            ["zoneIds"] = {
                [1] = 85,
            },
...
",
        ...
        ["Radnor, C.A."] = {
            ["icon"] = "CampaignArbiter.png",
            ["note"] = "Notes:\
* Jeuno affiliated Campaign Arbiter. Present when Beastmen have control of La Vaule (S) *Offers Campaign Information, Campaign Allied Tags, Teleportation *Campaign Sword in front of name during Campaign",
            ["type"] = "Campaign",
            ["zoneIds"] = {
                [1] = 85,
            },
