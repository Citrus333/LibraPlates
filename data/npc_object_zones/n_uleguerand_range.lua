return {
    ...
    ["catseyeNpc"] = {
        ["Mois"] = {
            ["icon"] = "Event.png",
            ["location"] = "North side cave below western ramp",
            ["note"] = "Mog Vault:\
...
",
        ...
        ["Zebada"] = {
            ["icon"] = "QuestNPC.png",
            ["note"] = "Notes:\
Trade him Chamnaet Ice to receive the Zephyr Fan needed to enter the following ENM's: *Brothers *Follow the White Rabbit *Holy Cow *When Hell Freezes Over",
            ["type"] = "ENM Quest",
            ["zoneIds"] = {
                [1] = 5,
            },
