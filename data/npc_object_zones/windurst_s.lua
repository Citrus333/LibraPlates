...
",
        ...
        ["Kuron-Makaron"] = {
            ...
            ["icon"] = "Dialogue.png",
            ["note"] = "Notes:\
* Lets you submit Campaign strategy recommendations before the next Campaign Tally.",
            ["type"] = "Survey",
        },
        ["Kyo"] = {
            ["_source"] = "npc",
...
* Bridge Too Far I (Windurst)",
        ...
        ["Pya"] = {
            ...
            ["icon"] = "CampaignArbiter.png",
            ["note"] = "Notes:\
* Summoned by Lhu Mhakaracca in campaign battles, along with Kyo.",
            ["type"] = "Campaign Battle",
        },
        ["Python Mercenary"] = {
            ["_source"] = "npc",
            ["icon"] = "CampaignArbiter.png",
            ["note"] = "Notes:\
Appears during Campaign Battles as part of the Python Mercenary squadron, led by Lhu Mhakaracca",
            ["type"] = "Campaign Battle",
        },
        ["Quartermaster"] = {
            ["_source"] = "npc",
