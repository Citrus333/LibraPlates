return {
    ...
    ["item"] = {
        ["Cargo Ship Door"] = {
            ...
            ["zones"] = {
                ...
                [3] = "Ship Bound for Mhaura",
                [4] = "Ship Bound for Mhaura (Pirates)",
                [5] = "Ship Bound for Selbina",
                [6] = "Ship Bound for Selbina (Pirates)",
                [7] = "Silver Sea Route to Al Zahbi",
                [8] = "Silver Sea Route to Nashmau",
            },
        },
        ["Door"] = {
            ["icon"] = "Door.png",
    ...
    ["npc"] = {
        ...
        ["Chhaya"] = {
            ...
            ["zones"] = {
                [1] = "Ship bound for Mhaura lower deck (Selbina to Mhaura route)",
            },
        },
        ["Sahn"] = {
...
Will report how long until the Ferry docks in Mhaura.",
            ...
            ["zones"] = {
                [1] = "Ship bound for Mhaura top deck (Selbina to Mhaura route)",
            },
        },
    },
}
