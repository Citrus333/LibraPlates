...
local function BuildPcPlateData(context)
    ...
    local blacklistNameColor = playerBlacklist.GetDisplayNameColor(context.player);
    nameColor = blacklistNameColor or nameColor;
    ...
    local plateData = {
        ...
        nameColor = blacklistNameColor or (context.nameAoeActive == true and context.aoeRangeSettings.fontColor) or nameColor,
