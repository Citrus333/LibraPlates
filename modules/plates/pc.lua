...
local function BuildPcPlateData(context)
    ...
    local plateData = {
        ...
        mpBar = {
            ...
            cornerRadius = tonumber(context.mpBarSettings.cornerRadius) or 0,
        ...
        tpBar = {
            ...
            cornerRadius = tonumber(context.tpBarSettings.cornerRadius) or 0,
...
local function QueuePlayerInternal(player, pcSpike, targetingSettings, otherPlayerDetail)
    ...
    local queuedActionRange = (canEvaluateHpBarRange == true and hpBarSettings.outOfRangeOpacityEnabled == true)
        and targetModuleMarker.GetEffectiveLiveSubtargetActionRange()
        or nil;
    ...
    if (cacheEligible == true) then
        ...
        signature = table.concat({
            ...
            suppressExpensiveWorldWidgets == true and 'newAdventurerIcon:suppressed' or ('newAdventurerIcon:' .. SettingKey(newAdventurerIconSettings, { 'enabled', 'loadMode', 'iconSize', 'offsetX', 'offsetY', 'anchorTo', 'anchorPoint', 'anchorCollapse', 'anchorSpacing', 'anchorOrder' })),
