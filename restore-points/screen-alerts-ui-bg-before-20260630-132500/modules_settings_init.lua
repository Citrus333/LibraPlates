...
function LibraPlatesSettingsDrawEnemyAlertsSection(useBoxedPage)
    ...
    if (useBoxedPage == true) then
        ...
        LibraPlatesSettingsDrawBoxedPage('ScreenAlertsPageContent', function()
            LibraPlatesSettingsDrawBoxedPanel('Screen Alerts', function()
            ...
            LibraPlatesSettingsDrawBoxedPanel('Offensive magic', function()
                DrawLane('Offensive magic', 'offensive', 'offensiveMagicEnabled', false);
            end);
            LibraPlatesSettingsDrawBoxedPanel('Defensive magic', function()
                DrawLane('Defensive magic', 'defensive', 'defensiveMagicEnabled', false);
            end);
            LibraPlatesSettingsDrawBoxedPanel('Job abilities', function()
