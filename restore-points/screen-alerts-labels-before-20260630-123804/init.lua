...
local generalSections = T{ 'Profiles', 'Theme', 'Native UI', 'Mouse', 'Visibility', 'Blacklist', 'Enemy Alerts', 'Scaling', 'Performance' };
...
local function DrawSelectedEditorGeneral()
    if (selectedTab == 'Settings') then
        ...
        elseif (selectedGeneralSection == 'Enemy Alerts') then
...
function LibraPlatesSettingsDrawEnemyAlertsSection(useBoxedPage)
    ...
    if (useBoxedPage == true) then
        LibraPlatesSettingsDrawBoxedBreadcrumb(T{ 'Settings', 'Enemy Alerts' });
        LibraPlatesSettingsDrawBoxedPage('EnemyAlertsPageContent', function()
            LibraPlatesSettingsDrawBoxedPanel('Enemy Alerts', DrawContent, true);
        end);
    else
        DrawContent();
    end
