...
area.",
        ...
        ["Emilio"] = {
            ["icon"] = "Emilio.png",
            ["location"] = "Provenance, Crystal Warrior only",
            ["note"] = "Crystal Warrior:\
