...
function LibraPlatesSettingsDrawGeneralBlacklistSection()
    ...
    LibraPlatesSettingsDrawBoxedPage('BlacklistPageContent', function()
        LibraPlatesSettingsDrawBoxedPanel('Visual blacklist', function()
            ...
            local color, colorChanged = DrawSettingsColor('Name color', blacklistSettings.displayNameColor, 'BlacklistDisplayNameColor');
        ...
        LibraPlatesSettingsDrawBoxedPanel('Entries', function()
            ...
            if (imgui.BeginTable ~= nil and imgui.TableSetupColumn ~= nil) then
                ...
                if (imgui.BeginTable('##visual_blacklist_entries', 5, flags)) then
                    imgui.TableSetupColumn('Name', 0, 150);
                    imgui.TableSetupColumn('Reason', 0, 300);
