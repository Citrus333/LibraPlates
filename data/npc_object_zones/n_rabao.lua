return {
    ["catseyeItem"] = {
        ["Book of Mastery"] = {
            ...
            ["location"] = "Rabao J-6, next to Adeptus",
...
* The NQ armor is consumed during transfer.",
    ...
    ["catseyeNpc"] = {
        ["Adeptus"] = {
            ["icon"] = "Event.png",
            ["location"] = "Rabao J-6, across from the Auction House",
            ["note"] = "Adept Reforging:\
...
* The Search for Goldmane",
        ...
        ["Zungutt"] = {
            ["icon"] = "PastEventWatcher.png",
            ["note"] = "Notes:\
* This NPC will let you watch cut-scenes that you have seen in Rabao in the past, for a small fee.",
