...
function state.GetVisualBlacklist()
    ...
    if (runtime.visualBlacklist.replaceName == nil) then
        runtime.visualBlacklist.replaceName = true;
    end
    if (type(runtime.visualBlacklist.nameColor) ~= 'table') then
        runtime.visualBlacklist.nameColor = { 1.0, 0.28, 0.28, 1.0 };
    end
